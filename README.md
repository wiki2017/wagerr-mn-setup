# Wagerr Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Wagerr Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/tkcXS34)
***
## Requirements
1) **25,000  WGR coins.**
...
`wget -q https://raw.githubusercontent.com/wiki2017/wagerr-mn-setup/master/wagerr_install.sh`
***
...
***Step 2***
* Send EXACLY 25,000 WGR to a receive address within your wallet.
***
